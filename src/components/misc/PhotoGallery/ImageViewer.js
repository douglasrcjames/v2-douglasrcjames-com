...
import { GrClose, GrZoomIn, GrZoomOut,  } from 'react-icons/gr';
import { AiFillDelete, AiOutlineInfoCircle, AiFillEdit } from 'react-icons/ai';
  ...
  render() {
    ...
    const HeaderClose = () => {
      return (
        ...
        >
          <GrClose style={{ width: "32px", height: "32px" }} color="#fff" />
        </button>
      );
    };
    ...
    const HeaderDelete = innerProps => {
      return (
        ...
        >
          <AiFillDelete style={{ width: "32px", height: "32px" }} color="#fff" />
        </button>
      );
    };
    ...
    const HeaderEdit = innerProps => {
      return (
        ...
        >
          <AiFillEdit style={{ width: "32px", height: "32px" }} color="#fff" />
        </button>
      );
    };
    ...
    const HeaderZoomIn = props => {
      return (
        ...
        >
          <GrZoomIn style={{ width: "32px", height: "32px" }} color="#fff" />
        </button>
      );
    };
    ...
    const HeaderZoomOut = props => {
      return (
        <button
          ...
          onClick={() => this.handleChangeZoom(-1)}
        >
          <GrZoomOut style={{ width: "32px", height: "32px" }} color="#fff" />
        </button>
      );
    };
    ...
    const FooterRejectionMessage = props => {
      ...
      return (
        ...
        >
          <AiOutlineInfoCircle color="#FF9800" style={{ marginRight: "10px" }} />
