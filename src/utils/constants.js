...
export const SKILLS = {
    ...
    ADOBE_PRODUCTS: { 
        name: "Adobe products", 
        link: "https://www.adobe.com/products/catalog.html",
        src: require(`../assets/images/icons/skills/adobe-products.png`) 
    },
    ...
    WIREFRAMING: { 
        ...
        src: require(`../assets/images/icons/skills/wireframing.png`) 
    },
    CPP: { 
        name: "C++", 
        link: "https://www.cplusplus.com/",
        src: require(`../assets/images/icons/skills/cpp.png`) 
    },
    VERILOG: { 
        name: "verilog", 
        link: "https://en.wikipedia.org/wiki/Verilog",
        src: require(`../assets/images/icons/skills/verilog.png`) 
    },
    ASM: { 
